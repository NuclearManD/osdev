...
.data:
	.file1			db 0;	    times 12 db 0
	.file2			db 0 ;	     times 12 db 0
...
.error:
	...
	.tmp_filename  db 0; times 15 db 0
...
; DATA SECTION
	...
	token	     db 0;	     times 255 db 0  ; Storage space for the token

vars_loc:
	variables	   dw 0;     times 26 dw 0   ; Storage space for variables A to Z

	for_variables	   dw 0;     times 26 dw 0   ; Storage for FOR loops
	for_code_points    dw 0;     times 26 dw 0   ; Storage for code positions where FOR loops start
	
	do_loop_store	  dw 0;      times 10 dw 0   ; Storage for DO loops
	...
	gosub_depth		db 0
	gosub_points	    dw 0;   times 10 dw 0   ; Points in code to RETURN to

	string_vars	  db 0;      times 1024 db 0 ; 8 * 128 byte strings
